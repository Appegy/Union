...
namespace Appegy.Union.Cells
{
    ...
    public partial struct PuzzleCell
        ...
        , System.IEquatable<Appegy.Union.Cells.Variants.VoidCell>
        , System.IEquatable<Appegy.Union.Cells.Variants.EmptyCell>
        , System.IEquatable<Appegy.Union.Cells.Variants.RegularCell>
    {
        [Serializable]
        ...
        [FieldOffset(1)]
        private Appegy.Union.Cells.Variants.VoidCell _voidCell;
        [FieldOffset(1)]
        private Appegy.Union.Cells.Variants.EmptyCell _emptyCell;
        [FieldOffset(1)]
        private Appegy.Union.Cells.Variants.RegularCell _regularCell;

        public Kind Type => _type;

        public Appegy.Union.Cells.Variants.VoidCell VoidCell
        {
        ...
        public Appegy.Union.Cells.Variants.EmptyCell EmptyCell
        {
        ...
        public Appegy.Union.Cells.Variants.RegularCell RegularCell
        {
        ...
        public PuzzleCell(Appegy.Union.Cells.Variants.VoidCell value)
        {
            _type = Kind.VoidCell;
            _emptyCell = default;
        ...
        public PuzzleCell(Appegy.Union.Cells.Variants.EmptyCell value)
        {
            _type = Kind.EmptyCell;
            _voidCell = default;
            _regularCell = default;
        ...
        public PuzzleCell(Appegy.Union.Cells.Variants.RegularCell value)
        {
            _type = Kind.RegularCell;
            _voidCell = default;
            _emptyCell = default;
        ...
        public override bool Equals(object boxed) => boxed switch
        {
            ...
            Appegy.Union.Cells.Variants.VoidCell other => Equals(other),
            Appegy.Union.Cells.Variants.EmptyCell other => Equals(other),
            Appegy.Union.Cells.Variants.RegularCell other => Equals(other),
            _ => throw new InvalidOperationException($"Unknown type of union: {_type}")
        };
        ...
        public bool Equals(Appegy.Union.Cells.Variants.VoidCell other) => _type == Kind.VoidCell && _voidCell.Equals(other);
        public bool Equals(Appegy.Union.Cells.Variants.EmptyCell other) => _type == Kind.EmptyCell && _emptyCell.Equals(other);
        public bool Equals(Appegy.Union.Cells.Variants.RegularCell other) => _type == Kind.RegularCell && _regularCell.Equals(other);

        public static implicit operator Appegy.Union.Cells.Variants.VoidCell(PuzzleCell other) => other.VoidCell;
        public static implicit operator PuzzleCell(Appegy.Union.Cells.Variants.VoidCell other) => new PuzzleCell(other);

        public static implicit operator Appegy.Union.Cells.Variants.EmptyCell(PuzzleCell other) => other.EmptyCell;
        public static implicit operator PuzzleCell(Appegy.Union.Cells.Variants.EmptyCell other) => new PuzzleCell(other);
